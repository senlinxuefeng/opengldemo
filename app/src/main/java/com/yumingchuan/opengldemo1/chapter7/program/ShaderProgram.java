...
public class ShaderProgram {
    ...
    protected static final String A_TEXTURE_COORDINATE = "a_TextureCoordinate";

    protected int program;

    public ShaderProgram(Context context, int vertexShaderResourceId, int fragmentShaderResourceId) {
        String vertexShaderSource = TextResourceReader.readTextFileResource(context, R.raw.texture_vertex_sharder_7);
        String fragmentShaderSource = TextResourceReader.readTextFileResource(context, R.raw.texture_fragment_sharder_7);
